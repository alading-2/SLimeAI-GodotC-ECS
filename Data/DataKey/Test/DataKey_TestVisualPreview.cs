...
{
    public static readonly DataKey<string> PreviewResourceKey = DataRegistry.Register<string>(
    ...
    public static readonly DataKey<string> PreviewResourcePath = DataRegistry.Register<string>(
    ...
    public static readonly DataKey<string> PreviewResourceCategory = DataRegistry.Register<string>(
    ...
    public static readonly DataKey<string> PreviewCatalogPath = DataRegistry.Register<string>(
    ...
    public static readonly DataKey<string> PreviewDefaultAnimation = DataRegistry.Register<string>(
    ...
    public static readonly DataKey<string> PreviewCurrentAnimation = DataRegistry.Register<string>(
