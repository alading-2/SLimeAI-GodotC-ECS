...
public static partial class DataKey
{
    ...
    // ========================================
    // 基础生命值
    public static readonly DataKey<float> BaseHp = DataRegistry.Register<float>(
    ...
    // 生命值加成
    public static readonly DataKey<float> HpBonus = DataRegistry.Register<float>(
    ...
    // 生命值
    public static readonly DataKey<float> FinalHp = DataRegistry.Register<float>(
        new DataMeta
        {
            Key = nameof(FinalHp),
            DisplayName = "生命值",
    ...
    // 生命百分比
    public static readonly DataKey<float> HpPercent = DataRegistry.Register<float>(
        new DataMeta
        {
    ...
    // 当前生命值
    public static readonly DataKey<float> CurrentHp = DataRegistry.Register<float>(
    ...
    // 基础生命恢复
    public static readonly DataKey<float> BaseHpRegen = DataRegistry.Register<float>(
    ...
    // 生命恢复加成
    public static readonly DataKey<float> HpRegenBonus = DataRegistry.Register<float>(
    ...
    // 百分比生命恢复
    public static readonly DataKey<float> PercentHpRegen = DataRegistry.Register<float>(
    ...
    // 生命恢复
    public static readonly DataKey<float> FinalHpRegen = DataRegistry.Register<float>(
        new DataMeta
        {
    ...
    // 吸血百分比
    public static readonly DataKey<float> LifeSteal = DataRegistry.Register<float>(
    ...
    // ========================================
    // 基础魔法值
    public static readonly DataKey<float> BaseMana = DataRegistry.Register<float>(
    ...
    // 魔法加成
    public static readonly DataKey<float> ManaBonus = DataRegistry.Register<float>(
    ...
    // 魔法值
    public static readonly DataKey<float> FinalMana = DataRegistry.Register<float>(
        new DataMeta
        {
    ...
    // 当前法力值
    public static readonly DataKey<float> CurrentMana = DataRegistry.Register<float>(
    ...
    // 魔法百分比
    public static readonly DataKey<float> ManaPercent = DataRegistry.Register<float>(
        new DataMeta
        {
    ...
    // 基础魔法恢复
    public static readonly DataKey<float> BaseManaRegen = DataRegistry.Register<float>(
    ...
    // 魔法恢复加成
    public static readonly DataKey<float> ManaRegenBonus = DataRegistry.Register<float>(
    ...
    // 百分比魔法恢复
    public static readonly DataKey<float> PercentManaRegen = DataRegistry.Register<float>(
    ...
    // 魔法恢复
    public static readonly DataKey<float> FinalManaRegen = DataRegistry.Register<float>(
        new DataMeta
        {
    ...
    // ========================================
    // 基础攻击力
    public static readonly DataKey<float> BaseAttack = DataRegistry.Register<float>(
    ...
    // 攻击力加成
    public static readonly DataKey<float> AttackBonus = DataRegistry.Register<float>(
    ...
    // 攻击力
    public static readonly DataKey<float> FinalAttack = DataRegistry.Register<float>(
        new DataMeta
        {
    ...
    // 基础攻速
    public static readonly DataKey<float> BaseAttackSpeed = DataRegistry.Register<float>(
    ...
    // 攻速加成
    public static readonly DataKey<float> AttackSpeedBonus = DataRegistry.Register<float>(
    ...
    // 攻速
    public static readonly DataKey<float> FinalAttackSpeed = DataRegistry.Register<float>(
        new DataMeta
        {
    ...
    // 攻击间隔
    public static readonly DataKey<float> AttackInterval = DataRegistry.Register<float>(
        new DataMeta
        {
    ...
    // 伤害增幅
    public static readonly DataKey<float> DamageAmplification = DataRegistry.Register<float>(
    ...
    // 护甲穿透
    public static readonly DataKey<float> Penetration = DataRegistry.Register<float>(
    ...
    // 攻击范围
    public static readonly DataKey<float> AttackRange = DataRegistry.Register<float>(
    ...
    // 攻击前摇
    public static readonly DataKey<float> AttackWindUpTime = DataRegistry.Register<float>(
    ...
    // 攻击后摇
    public static readonly DataKey<float> AttackRecoveryTime = DataRegistry.Register<float>(
    ...
    // 击退
    public static readonly DataKey<float> Knockback = DataRegistry.Register<float>(
    ...
    // ========================================
    // 基础防御
    public static readonly DataKey<float> BaseDefense = DataRegistry.Register<float>(
    ...
    // 防御加成
    public static readonly DataKey<float> DefenseBonus = DataRegistry.Register<float>(
    ...
    // 防御
    public static readonly DataKey<float> FinalDefense = DataRegistry.Register<float>(
        new DataMeta
        {
    ...
    // 伤害减免
    public static readonly DataKey<float> DamageReduction = DataRegistry.Register<float>(
    ...
    // 受伤倍率（1=正常，<1减伤，>1易伤）
    public static readonly DataKey<float> DamageTakenMultiplier = DataRegistry.Register<float>(
    ...
    // 护盾
    public static readonly DataKey<float> Shield = DataRegistry.Register<float>(
    ...
    // 反伤
    public static readonly DataKey<float> Thorns = DataRegistry.Register<float>(
    ...
    // 护甲
    public static readonly DataKey<float> Armor = DataRegistry.Register<float>(
    ...
    // 无敌时间
    public static readonly DataKey<float> InvincibilityTime = DataRegistry.Register<float>(
    ...
    // ========================================
    // 移动速度
    public static readonly DataKey<float> MoveSpeed = DataRegistry.Register<float>(
    ...
    // 移动速度加成
    public static readonly DataKey<float> MoveSpeedBonus = DataRegistry.Register<float>(
    ...
    // 移动速度
    public static readonly DataKey<float> FinalMoveSpeed = DataRegistry.Register<float>(
        new DataMeta
        {
    ...
    // ========================================
    // 闪避几率
    public static readonly DataKey<float> DodgeChance = DataRegistry.Register<float>(
    ...
    // ========================================
    // 暴击率
    public static readonly DataKey<float> CritRate = DataRegistry.Register<float>(
    ...
    // 暴击伤害
    public static readonly DataKey<float> CritDamage = DataRegistry.Register<float>(
    ...
    // ========================================
    // 拾取范围
    public static readonly DataKey<float> PickupRange = DataRegistry.Register<float>(
    ...
    // 经验倍率
    public static readonly DataKey<float> ExpGain = DataRegistry.Register<float>(
    ...
    // 幸运值
    public static readonly DataKey<float> LuckBonus = DataRegistry.Register<float>(
    ...
    // 磁铁吸附速度
    public static readonly DataKey<float> MagnetSpeed = DataRegistry.Register<float>(
    ...
    // 磁铁开关
    public static readonly DataKey<bool> MagnetEnabled = DataRegistry.Register<bool>(
    ...
    // ========================================
    // 有效生命
    public static readonly DataKey<float> EffectiveHp = DataRegistry.Register<float>(
        new DataMeta
        {
    ...
    // DPS
    public static readonly DataKey<float> DPS = DataRegistry.Register<float>(
        new DataMeta
        {
            Key = nameof(DPS),
            DisplayName = "DPS",
