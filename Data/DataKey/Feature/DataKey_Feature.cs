...
public static partial class DataKey
{
    ...
    public static readonly DataKey<string> FeatureCategory = DataRegistry.Register<string>(
    ...
    public static readonly DataKey<string> FeatureHandlerId = DataRegistry.Register<string>(
    ...
    // Feature 是否当前处于启用状态
    public static readonly DataKey<bool> FeatureEnabled = DataRegistry.Register<bool>(
    ...
    // Feature 是否当前处于激活执行中
    public static readonly DataKey<bool> FeatureIsActive = DataRegistry.Register<bool>(
    ...
    // Feature 被激活的累计次数
    public static readonly DataKey<int> FeatureActivationCount = DataRegistry.Register<int>(
