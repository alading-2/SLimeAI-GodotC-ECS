...
本文是总说明，不建议直接作为一次性大任务执行。已拆分为多个可独立运行的阶段计划：

- [README.md](../../../../Plans/Architecture/AI_First_Program_Migration/README.md) - 计划索引与推荐执行顺序
- [01_DocsAI_Document_System_Migration.md](../../../../Plans/Architecture/AI_First_Program_Migration/01_DocsAI_Document_System_Migration.md) - Docs / DocsAI 文档体系迁移
- [02_Godot_CLI_Test_Debug_Loop.md](../../../../Plans/Architecture/AI_First_Program_Migration/02_Godot_CLI_Test_Debug_Loop.md) - Godot CLI 测试与日志 Debug 闭环
- [03_Skill_System_Refactor.md](../../../../Plans/Architecture/AI_First_Program_Migration/03_Skill_System_Refactor.md) - Skill 体系重构
- [04_Framework_Module_Contract_Docs.md](../../../../Plans/Architecture/AI_First_Program_Migration/04_Framework_Module_Contract_Docs.md) - 框架模块 AI 契约文档
- [05_Long_Task_Context_And_Project_Plans.md](../../../../Plans/Architecture/AI_First_Program_Migration/05_Long_Task_Context_And_Project_Plans.md) - 长任务上下文与项目计划机制
- [06_AI_First_Feature_Development_Pilot.md](../../../../Plans/Architecture/AI_First_Program_Migration/06_AI_First_Feature_Development_Pilot.md) - AI-First 功能开发闭环试点
- [07_Core_Regression_And_Review_Gate.md](../../../../Plans/Architecture/AI_First_Program_Migration/07_Core_Regression_And_Review_Gate.md) - ECS 核心回归与人工审查门禁
- [Progress.md](../../../../Plans/Architecture/AI_First_Program_Migration/Progress.md) - 当前阶段、已完成、未完成和下一步
- [Backlog.md](../../../../Plans/Architecture/AI_First_Program_Migration/Backlog.md) / [Done.md](../../../../Plans/Architecture/AI_First_Program_Migration/Done.md) - 后续任务和阶段完成记录
- [PlanTemplate_Example.md](../../../../Plans/Architecture/AI_First_Program_Migration/PlanTemplate_Example.md) - 当前计划目录结构示例

执行时应按 `00` 中的顺序逐个推进，避免把文档迁移、Skill 重构、测试工具和功能试点混成一个不可审查的大改。

项目级计划统一放在仓库根目录 `Plans/`，并按“分类目录 -> 计划目录”组织。`DocsAI/` 只放 AI 执行协议、模块契约、测试说明和 Skill 映射，避免计划入口分叉。
...
```text
/Plans/<分类>/<计划名>/Progress.md
/Plans/<分类>/<计划名>/Backlog.md
/Plans/<分类>/<计划名>/Done.md
/Docs/DecisionLog.md
/Docs/KnownIssues.md
```
