...
3. 参数、写法、时间轴、AbilityImpactTool 用法 → 看 [`references/ability-logic-parameters.md`](./references/ability-logic-parameters.md)
4. 需要查系统全局入口或模块位置 → 看 `Docs/框架/项目索引.md`
5. 真正落代码时，再去打开对应 Handler / Tool / 组件源码
