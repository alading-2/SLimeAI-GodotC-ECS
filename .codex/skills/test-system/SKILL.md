...
- 通过 `SystemManager.Execute<SpawnSystem, SpawnBatchRequest, SpawnBatchResult>(...)` 批量生成
- 通过 `SystemManager.Execute<SpawnSystem, KillAllEnemiesRequest, KillAllEnemiesResult>(...)` 清理敌人
