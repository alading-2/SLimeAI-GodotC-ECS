...
const TablesPluginEditorViewClass := preload("res://addons/resources_table/editor_view.gd")
const TablesPluginSelectionManagerClass := preload("res://addons/resources_table/main_screen/selection_manager.gd")
const TextEditingUtilsClass := preload("res://addons/resources_table/text_editing_utils.gd")
