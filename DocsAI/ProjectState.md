...
- 新增 SlimeAI 多仓库彻底迁移方向：当前 `brotato-my` 降级为迁移输入仓库；长期建设迁入 `SlimeAI` AI 框架主仓库、独立 Godot 引擎仓库和独立游戏仓库。
...
- `Plans/Architecture/SlimeAI_多仓库彻底迁移/README.md`：当前更高层的多仓库迁移计划，规定工作区、仓库边界、NuGet/DLL 阶段、游戏 Skill 和旧仓库归档策略。
...
- SlimeAI 多仓库迁移：`Plans/Architecture/SlimeAI_多仓库彻底迁移/README.md`
- Godot AI Game OS 执行计划：`Plans/Architecture/Godot_AI_Game_OS_Migration/README.md`
- 多仓库 AI 工作流：`DocsAI/Protocols/SlimeAI多仓库AI工作流协议.md`
