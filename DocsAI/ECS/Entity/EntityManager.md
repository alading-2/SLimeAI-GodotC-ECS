<!-- migrated-from: Src/ECS/Base/Entity/Core/EntityManager.md -->

> 迁移来源：`Src/ECS/Base/Entity/Core/EntityManager.md`
...
| 文件 | 职责 |
|------|------|
| [EntityManager.cs](../../../Src/ECS/Base/Entity/Core/EntityManager.cs) | 核心生命周期管理（Spawn, Register, Destroy）、基础查询（GetEntitiesByType, GetEntityById）、全局查询（GetAllEntities, GetEntitiesByInterface） |
| [EntityManager_Component.cs](../../../Src/ECS/Base/Entity/Core/EntityManager_Component.cs) | Component 管理（RegisterComponents, AddComponent, GetComponent, RemoveComponent） |
| [EntityManager_Migration.cs](../../../Src/ECS/Base/Entity/Core/EntityManager_Migration.cs) | Entity 迁移扩展（新建目标实体、迁移受控 Data、销毁源实体） |
| [EntityManager_Ability.cs](../../../Src/ECS/Base/System/AbilitySystem/EntityManager_Ability.cs) | Ability 管理（AddAbility, RemoveAbility, GetAbilities） |
...
```csharp
// 1. 配置注入阶段
var enemy = EntityManager.Spawn<Enemy>(config); // 内部执行 Data.snapshot record apply + OnComponentRegistered
...
- **架构设计**：[Entity 概念](./Concept.md)
- **详细设计**：[EntityManager](./EntityManager.md)
