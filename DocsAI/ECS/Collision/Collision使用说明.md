...
- `Src/ECS/Base/Component/Collision/CollisionComponent/` — 视觉体碰撞桥接
- `Src/ECS/Base/Component/Collision/HurtboxComponent/` — 受击区碰撞桥接
- `Src/ECS/Base/Component/Collision/ContactDamageComponent/` — 接触伤害
- `Src/ECS/Base/Component/Collision/PickupComponent/` — 拾取
