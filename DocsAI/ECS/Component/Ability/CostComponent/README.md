<!-- migrated-from: Src/ECS/Base/Component/Ability/CostComponent/README.md -->

> 迁移来源：`Src/ECS/Base/Component/Ability/CostComponent/README.md`
...
- [AbilitySystem 使用文档](../../../System/AbilitySystem/Usage.md)
- [ChargeComponent 使用文档](../ChargeComponent/README.md)
- [CooldownComponent 使用文档](../CooldownComponent/README.md)
