...
- 文档迁移：`DocsAI/Workflows/文档迁移协议.md`
...
- 项目导航：`.codex/skills/project-index/SKILL.md`
- Godot 场景测试：`.codex/skills/godot-scene-test/SKILL.md`
- Entity 生命周期：`.codex/skills/ecs-entity/SKILL.md`
- Component 开发：`.codex/skills/ecs-component/SKILL.md`
...
- AI-First 总说明：`Docs/框架/优化/AI/ai_first_godot_csharp_ecs_program_overview.md`
