...
```bash
rg -n "<SymbolName>" SlimeAI Games/BrotatoLike Resources/Else/brotato-my openspec SlimeAI/DocsAI -S
```

5. 对照 SDD、历史 `openspec/specs/<capability>/spec.md`、`SlimeAI/DocsAI/ProjectState.md`、Contract / ApiIndex、tests。
