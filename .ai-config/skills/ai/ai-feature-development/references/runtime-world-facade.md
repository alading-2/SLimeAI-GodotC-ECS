...
> Baseline 由 `SlimeAI/DocsAI/GameOS/Contracts.md`、`SlimeAI/DocsAI/GameOS/ApiIndex.md` 与当前 SDD 管理。本文件只提供 AI 路由级摘要。
...
- Contract：`SlimeAI/DocsAI/GameOS/Contracts.md#runtimeworld-契约`
- API：`SlimeAI/DocsAI/GameOS/ApiIndex.md`
- Historical specs：`openspec/specs/runtime-world-container/spec.md`、`openspec/specs/runtime-command-buffer/spec.md`
- Tests：`SlimeAI/Tests/SlimeAI.GameOS.Tests/World/RuntimeWorldTests.cs`
