...
> Baseline 由 `SlimeAI/DocsAI/GameOS/Contracts.md`、相关 Capability contract 与当前 SDD 管理。历史基线见 `openspec/specs/runtime-relationship-lifecycle/spec.md` 与 `openspec/specs/runtime-business-entity-references/spec.md`。
