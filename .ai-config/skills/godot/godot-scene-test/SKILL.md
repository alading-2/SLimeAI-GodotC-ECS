...
- runner 源：`/home/slime/Code/SlimeAI/.ai-config/skills/godot/godot-scene-test/scripts/godot-scene-runner.mjs`
- analyzer 源：`/home/slime/Code/SlimeAI/.ai-config/skills/godot/godot-scene-test/scripts/analyze-logs.sh`
...
- 框架级新场景放在框架仓 `Src/Validation/<Area>/<Layer>/`，脚本放在 `Src/Validation/<Area>/<Layer>/`，旁置 `README.md`，并按 `DocsAI/Tests/GodotSceneValidation.md` 输出 PASS/FAIL marker 和 JSON artifact。
