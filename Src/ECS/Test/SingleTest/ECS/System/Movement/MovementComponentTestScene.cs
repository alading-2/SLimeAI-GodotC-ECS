...
namespace Slime.Test
{
    internal partial class MovementComponentTestScene : Node2D
    {
        ...
        private void SpawnDemo(DemoId id)
        {
            ...
            entity.Events.On<GameEventType.Unit.MovementCompleted>(GameEventType.Unit.MovementCompleted, _ => OnDemoCompleted(id));
            StartDemo(id);
        }
        ...
        private void StartDemo(DemoId id)
        {
            ...
            demo.Entity.Events.Emit(GameEventType.Unit.MovementStarted, new GameEventType.Unit.MovementStarted(BuildMode(id), BuildParams(id)));
        }
