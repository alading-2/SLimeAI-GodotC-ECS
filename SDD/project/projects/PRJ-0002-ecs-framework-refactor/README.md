...
23. `design/Tool/10.Log/07-当前样本日志问题与整理方案.md` — 2026-06-10 样本日志真实问题和 analyzer 整理方案
...
29. `design/Tool/ObjectPool/README.md` — ObjectPool 当前共享设计包入口
30. `sdds/018-SDD-0028-objectpool-collision-parkedintree-cutover/README.md` — ObjectPool / Collision 执行型 SDD 胶囊
31. `sdds/018-SDD-0028-objectpool-collision-parkedintree-cutover/execution-prompt.md` — ObjectPool / Collision 新会话执行提示词
32. `design/Tool/其他Tool/README.md` — Input/ObjectPool/Timer 已改且 Log 跳过后的剩余 Tools AI-first 设计包入口
33. `design/Tool/其他Tool/01-现状证据与AI-first裁决.md` — 剩余 Tools 总体分析、已确认/未确认问题和默认假设
34. `design/Tool/其他Tool/02-CommonTool与ResourceManagement裁决.md` — Common Utilities、ResourceLoading / ResourceManagement、ResourceGenerator 和 project-filesystem workflow
35. `design/Tool/其他Tool/06-实施路线与验证门禁.md` — 剩余 Tools 后续执行 SDD 拆分、BDD、grep gate 和验证命令
36. `sdds/025-SDD-0035-runtime-mount-and-node-lifecycle-hard-cutover/README.md` — Runtime mount + NodeLifecycle 执行型 SDD 胶囊
37. `sdds/025-SDD-0035-runtime-mount-and-node-lifecycle-hard-cutover/execution-prompt.md` — SDD-0035 新会话执行提示词
38. `sdds/026-SDD-0036-target-query-engine-hard-cutover/README.md` — TargetQueryEngine 执行型 SDD 胶囊
39. `sdds/026-SDD-0036-target-query-engine-hard-cutover/execution-prompt.md` — SDD-0036 新会话执行提示词
40. `sdds/027-SDD-0037-resource-loading-and-common-utilities-hard-cutover/README.md` — ResourceLoading + CommonUtilities 执行型 SDD 胶囊
41. `sdds/027-SDD-0037-resource-loading-and-common-utilities-hard-cutover/execution-prompt.md` — SDD-0037 新会话执行提示词
42. `sdds/028-SDD-0038-math-formula-and-deterministic-random-cutover/README.md` — MathFormula + deterministic RNG 执行型 SDD 胶囊
43. `sdds/028-SDD-0038-math-formula-and-deterministic-random-cutover/execution-prompt.md` — SDD-0038 新会话执行提示词
44. `design/Runtime/7.Component/README.md` — Runtime Component AI-first 优化共享设计包入口
45. `design/Runtime/7.Component/04-Component代码化组合与参数注入裁决.md` — Component Preset 纯代码化和参数注入裁决
46. `sdds/020-SDD-0030-component-code-composition-and-contract-hardening/README.md` — Component code composition 执行型 SDD 胶囊
47. `DocsAI/ECS/Runtime/Component/ComponentManifest.md` — Component current manifest
48. `design/Runtime/8.System优化/README.md` — Runtime System AI-first 优化共享设计包入口
49. `sdds/019-SDD-0029-system-contract-manifest-and-diagnostics-hardening/README.md` — System contract 执行型 SDD 胶囊
50. `sdds/019-SDD-0029-system-contract-manifest-and-diagnostics-hardening/execution-prompt.md` — System contract 新会话执行提示词
51. `sdds/` — 项目内有序 SDD
52. `Core/notes.md` — 参考与开放问题
