...
5. `entity-rewrite-execution-prompt.md` — Entity / Relationship hard cutover 总执行提示词
6. `sdds/012-SDD-0022-data-projection-diagnostics-contract-hardening/progress.md` — Data residual contract hardening 已完成记录
7. `sdds/011-SDD-0021-data-no-compatibility-hard-cutover/execution-prompt.md` — Data 无兼容 hard cutover 已完成记录
8. `data-rewrite-execution-prompt.md` — Data Full Rewrite 历史总执行提示词，SDD-0012~SDD-0019 使用
9. `roadmap.md` — 设计文档到 SDD 的映射、执行顺序、依赖和状态
10. `progress.md` — 项目级关键结论和恢复点
11. `sdds/` — 项目内有序 SDD
12. `notes.md` — 参考与开放问题
