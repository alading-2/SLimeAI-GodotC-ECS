...
> 更新：2026-06-15
> 状态：完整重构主链路已按 SDD-0012~SDD-0022 收口；2026-06-15 后续方向已改为“运行时功能解耦优先，数据形态统一和表格驱动都不是底层第一目标”。当前继续 Data 前先读 `5.Data类型系统重构/00-README.md`、`5.Data类型系统重构/09-Data系统根本裁决与重构路线.md`、`5.Data类型系统重构/10-运行时解耦与表格驱动顺序校准.md` 和 `6.架构学习/06-运行时解耦第一原则与框架目标.md`。
...
> 类型系统重构入口：[`5.Data类型系统重构/00-README.md`](./5.Data类型系统重构/00-README.md)。
> 架构学习入口：[`6.架构学习/README.md`](./6.架构学习/README.md)。
> 运行时解耦第一原则：[`6.架构学习/06-运行时解耦第一原则与框架目标.md`](./6.架构学习/06-运行时解耦第一原则与框架目标.md)。
