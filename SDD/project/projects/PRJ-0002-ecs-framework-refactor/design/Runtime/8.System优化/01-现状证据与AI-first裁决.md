...
- 在 `design/Runtime/8.System优化/` 下生成可恢复的共享设计包。
...
- DocsAI `Runtime/System` 仍是 current 文档入口；SDD `design/Runtime/8.System优化/` 是共享设计事实源。
...
- `SDD/project/projects/PRJ-0002-ecs-framework-refactor/design/Runtime/8.System优化/01-现状证据与AI-first裁决.md`
- `SDD/project/projects/PRJ-0002-ecs-framework-refactor/design/Runtime/8.System优化/02-目标架构与优化路线.md`
- `SDD/project/projects/PRJ-0002-ecs-framework-refactor/design/Runtime/8.System优化/03-调用点迁移与验证计划.md`
- `SDD/project/projects/PRJ-0002-ecs-framework-refactor/design/INDEX.md`
- `SDD/project/projects/PRJ-0002-ecs-framework-refactor/roadmap.md`
