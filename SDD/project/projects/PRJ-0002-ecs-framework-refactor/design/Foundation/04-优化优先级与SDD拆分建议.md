...
- `design/Runtime/3.Entity系统优化/README.md`
- `design/Runtime/3.Entity系统优化/01-目标架构与模块拆分.md`
- `design/Runtime/3.Entity系统优化/02-代码实现说明.md`
- `design/Runtime/3.Entity系统优化/03-LifecycleTree与业务引用设计.md`
- `design/Runtime/3.Entity系统优化/04-完全重构范围与TDD测试计划.md`
- `design/Runtime/3.Entity系统优化/05-源码调用点迁移清单.md`
- `Core/entity-rewrite-execution-prompt.md`
...
- 后续可以创建 Entity 执行型 SDD，但必须按 `Core/entity-rewrite-execution-prompt.md` 的 TDD 任务序推进。
...
- `design/Runtime/3.Entity系统优化/` 已提供目标架构、代码实现说明、业务引用替换、TDD 计划和源码调用点迁移清单。
