...
- `../../design/Runtime/2.Data系统优化/05-Data重构运行报错根因分析.md`：`AbilityIcon` / `AvailableAnimations` 运行报错根因。
- `../../design/Runtime/2.Data系统优化/06-无兼容完全重构总审计/README.md`：项目级最新 Data 无兼容审计事实源。
