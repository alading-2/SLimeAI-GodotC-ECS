...
- `design/2.Data系统优化/README.md` §10.1、§10.2、§13。
- `design/2.Data系统优化/01-代码实现说明.md` §2、§3、§4、§5、§8、§14。
- `design/2.Data系统优化/03-完全重构范围与TDD测试计划.md` §4.2。
...
- 测试工程/目录最终位置执行时确认；不影响本 SDD 的行为边界。
