...
- [x] T1.3 ResourceLoading facade implementation
...
- [x] T1.4 Remove contains fallback
...
- [x] T1.5 LoadPath source policy and PackedScene migration
...
- [x] T1.6 ResourceCatalogDiagnostics
...
- [x] T1.8 Common Utilities owner setup
