...
- `design/2.Data系统优化/02-DataMeta属性审计与Feature计算边界.md` §3、§6、§7.2。
- `design/2.Data系统优化/03-完全重构范围与TDD测试计划.md` §4.4、§4.7。
...
- Feature source id 的稳定格式执行时与 FeatureSystem owner 确认。
