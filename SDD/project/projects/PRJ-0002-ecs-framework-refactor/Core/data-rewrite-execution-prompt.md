...
4. `design/INDEX.md`
5. `design/main.md`
6. `design/Foundation/04-优化优先级与SDD拆分建议.md`

再读 Data 完整重构事实源：

1. `design/Runtime/2.Data系统优化/README.md`
2. `design/Runtime/2.Data系统优化/01-代码实现说明.md`
3. `design/Runtime/2.Data系统优化/02-DataMeta属性审计与Feature计算边界.md`
4. `design/Runtime/2.Data系统优化/03-完全重构范围与TDD测试计划.md`
