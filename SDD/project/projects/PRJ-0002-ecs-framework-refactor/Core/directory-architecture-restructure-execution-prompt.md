...
4. `SDD/project/projects/PRJ-0002-ecs-framework-refactor/design/Runtime/6.ECS框架目录架构大重构/README.md`
5. `SDD/project/projects/PRJ-0002-ecs-framework-refactor/design/Runtime/6.ECS框架目录架构大重构/01-现状证据与AI-first裁决.md`
6. `SDD/project/projects/PRJ-0002-ecs-framework-refactor/design/Runtime/6.ECS框架目录架构大重构/02-目标目录架构与归属规则.md`
7. `SDD/project/projects/PRJ-0002-ecs-framework-refactor/design/Runtime/6.ECS框架目录架构大重构/03-迁移切片与验证门禁.md`
